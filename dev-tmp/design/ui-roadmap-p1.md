...
| v3.2 | 2026-07-06 | UiSelect v2 定稿（自渲染 popper + Vercel 视觉 + 多选/搜索/异步预留）。同步更新 [`caduceus-design.md`](../../designingDocument/caduceus-design.md) §十二表格 + 新增 §1.2 第 8 条"禁止原生 `<select>`"原则；批量替换业务代码 7 处原生 `<select>` 为 UiSelect；API 完整规范沉淀至 [`ui-component-api-reference.md §11.3`](./ui-component-api-reference.md) |